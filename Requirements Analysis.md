...
1. Ο Χρήστης που επιθυμεί να εγγραφεί ως Γονέας, επιλέγει το πεδίο "Εγγραφή" από την αρχική σελίδα της web εφαρμογής.
2. Στη συνέχεια επιλέγει το πεδίο "Εγγραφή ως Γονέας" και μεταφέρεται στην αντίστοιχη σελίδα, όπου υπάρχει η κατάλλληλη φόρμα εγγραφής.
3. Στη φόρμα αυτή ο ενδιαφερόμενος πρέπει να συμπληρώσει το Ονοματεπώνυμό του, τη διέυθυνση e-mail του, ένα τηλέφωνο επικοινωνίας και τη διεύθυνση κατοικίας του.
4. Επιλέγοντας "Συνέχεια" ο ενδιαφερόμενος μεταφέρεται σε διαφορετική σελίδα, η οποία τον ενημερώνει ότι η αίτηση εγγραφής του είναι υπό εξέταση και ότι θα ενημερωθεί σύντομα μέσω e-mail. για την εξέλιξή της.
5. **ΠΡΕΠΕΙ ΝΑ ΑΠΟΦΑΣΙΣΟΥΜΕ ΠΡΩΤΑ ΜΕΤΑΞΥ ΜΑΣ ΚΑΙ ΜΕΤΑ ΘΑ ΤΟ ΣΥΝΕΧΙΣΩ**
...
<h>**4. Δημιουργία e-wallet από Γονέα και φόρτιση με πόντους**</h>
    <p>**Σκοπός** του παρόντος Σεναρίου Χρήσης είναι η δημιουργία ενός e-wallet το οποίο θα ανήκει στον ενδιαφερόμενο Χρήστη-Γονέα και η φόρτισή του με πόντους. **Αποτέλεσμα** του Σεναρίου είναι να έχει ο συγκεκριμένος Χρήστης-Γονέας στη διάθεσή του ένα σύνολο πόντων, τους οποίους "αποθηκεύει" στο e-wallet που έφτιαξε και μπορελι να τους εξαργυρώσει στην αγορά εισητηρίων. **Δράστες** του παρόντος σεναρίου είναι να οι Ταυτοποιημένοι Χρήστες της πλατφόρμας Little Cherries που έχουν το ρόλο του Γονέα και απαραίτητη **Προϋπόθεση** για τη λειτουργία του Σεναρίου
