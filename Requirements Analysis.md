...
+ 1.1 Ο Χρήστης που επιθυμεί να εγγραφεί ως Γονέας, επιλέγει το πεδίο "Εγγραφή" από την αρχική σελίδα της web εφαρμογής.
+ 1.2 Στη συνέχεια επιλέγει το πεδίο "Εγγραφή ως Γονέας" και μεταφέρεται στην αντίστοιχη σελίδα, όπου υπάρχει η κατάλλληλη φόρμα εγγραφής.
+ 1.3 Στη φόρμα αυτή ο ενδιαφερόμενος πρέπει να συμπληρώσει το Ονοματεπώνυμό του, τη διέυθυνση e-mail του, ένα τηλέφωνο επικοινωνίας και τη διεύθυνση κατοικίας του.
+ 1.4 Επιλέγοντας "Συνέχεια" ο ενδιαφερόμενος μεταφέρεται σε διαφορετική σελίδα, η οποία τον ενημερώνει ότι η αίτηση εγγραφής του είναι υπό εξέταση και ότι θα ενημερωθεί σύντομα μέσω e-mail. για την εξέλιξή της.
+ 
+ 
    </p>
