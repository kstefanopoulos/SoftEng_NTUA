...
<h> **2.3. Διάγραμμα κλάσεων Δραστών** </h>
    ...
    ![Actors Overniew](Class_diagramm.png)
    </p>
...
+ 1. Εγγραφή Γονέα στην Πλατφόρμα
+ 2. Εγγραφή Παρόχου στην Πλατφόρμα**
+ 3. Προσθήκη/Διαγραφή admin
+ 4. Δημιουργία e-wallet από Γονέα και φόρτιση με πόντους
+ 5. Επεξεργασία Προφίλ Γονέα
+ 6. Επεξεργασία Προφίλ Παρόχου
+ 7. Κλείδωμα Προφίλ από admin
+ 8. Αλλαγή Password Ταυτοποιημένου Χρήστη
