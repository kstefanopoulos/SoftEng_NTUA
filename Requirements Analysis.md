...
![Parent Subscription](Parent_subscription.png){:height="10px" width="18px"}
...
<h> **5.1. Διαθεσιμότητα - Ανάνηψη από καταστροφές** </h>
    <p> Η συνεχής διαθεσιμότητα του συστήματος μπορεί να διασφαλιστεί με τακτικό backup της βάσης δεδομένων και με τη δημιουργία δομών για redeployment σε περίπτωση απροόπτου. </p>
