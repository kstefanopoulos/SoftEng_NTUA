...
<h>**2. Εγγραφή Παρόχου στην Πλατφόρμα** </h>
    ...
    Ως **Δράστες** του Σεναρίου θεωρούμε κάποιον Υπέυθυνο Επικοινωνίας της Επιχείρησης, ο οποίος μετά το τέλος του Σεναρίου θα θεωρείται από το Σύστημά μας  ως ο αντίστοιχος Πάροχος για τη συγκεκριμένη επιχείρηση.
