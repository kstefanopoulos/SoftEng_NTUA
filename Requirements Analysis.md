...
3. Έπειτα, το Σύστημα πληροφορεί τον Χρήστη ότι η αίτηση εγγραφής του είναι υπό εξέταση και ότι θα ενημερωθεί σύντομα μέσω e-mail. για την εξέλιξή της.
4. **ΠΡΕΠΕΙ ΝΑ ΑΠΟΦΑΣΙΣΟΥΜΕ ΠΡΩΤΑ ΜΕΤΑΞΥ ΜΑΣ ΚΑΙ ΜΕΤΑ ΘΑ ΤΟ ΣΥΝΕΧΙΣΩ**
...
1. Ο Χρήστης-Γονέας, αφού έχει εισέλθει στο λογαριασμό του επιλέγει τη λειτουργία της δημιουργίας νέου e-wallet.
2. Στη φόρμα που εμφανίζεται στη συνέχεια και περιέχει τα ήδη γνωστά στοιχεία για το Γονέα (Ονοματεπώνυμο και Τηλέφωνο), ο Χρήστης συμπληρώνει τον αριθμό της πιστωτικής κάρτας με την οποία θα συνδεθεί το e-wallet.
3. Δημιουργείται το ζητούμενο ηλεκτρονικό πορτοφόλι και ο Χρήστης έχει τη δυνατότητα να αγοράσει πόντους.
4. Επιλέγοντας τους πόντους που θέλει να αγοράσει και με βάση την Παραδοχή νο.4 που αναφέρουμε στην ενότητα 2.6, αυτοί οι πόντοι προστίθενται στο προσωπικό του e-wallet, και αφαιρείται από τον τραπεζικό λογαριασμό που συμπλήρωσε στο βήμα 2, το αντίστοιχο χρηματικό ποσό.
...
3. Οι Γονείς και οι Πάροχοι έχουν έγκυρη πιστωτική κάρτα(ή τραπεζικο λογαριασμο?).
