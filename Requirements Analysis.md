...
2. Στη φόρμα αυτή ο ενδιαφερόμενος πρέπει να συμπληρώσει το Ονοματεπώνυμό του, τη διέυθυνση e-mail του, ένα τηλέφωνο επικοινωνίας, τη διεύθυνση κατοικίας του, username και password της επιλογης του, και προεραιτικά φωτογραφία προφίλ.
...
<h>**6. Επεξεργασία Προφίλ Γονέα/Παρόχου**</h>
    <p>**Σκοπός** του έκτου Σεναρίου Χρήσης είναι η επεξεργασία του προφίλ ενός Γονέα ή ενός Παρόχου, από τον ίδιο. Οι δύο αυτές περιπτώσεις παρουσιάζουν αρκετές ομοιότητες για αυτό και θα τις αναλύσουμε μαζί. **Αποτέλεσμα** του Σεναρίου θα είναι η αλλαγή των στοιχείων που υπάρχουν στη Βάση Δεδομένων του Συστήματος, για το συγκεκριμένο Χρήστη.
...
<h> **5.1. Διαθεσιμότητα - Ανάνηψη από καταστροφές** </h>
    <p> Η συνεχής διαθεσιμότητα του συστήματος μπορεί να διασφαλιστεί με τακτικό backup της βάσης δεδομένων και με τη δημιουργία δομών για redeployment
        σε περίπτωση απροόπτου. Eπίσης, καλή πρακτική είναι η χρήση spare servers, ιδανικά σε μορφή cloud, για τη διατήρηση της λειτουργίας του συστήματος
        κατά το recovery phase.</p>
<h> **5.2. Ασφάλεια - Ακεραιότητα** </h>
    <p> Η ασφάλεια της πλατφόρμας προκύπτει από την ταυτοποίηση των χρηστών(στο back end), προκειμένου να εκτελέσουν τις διάφορες λειτουργίες, καθώς
        και από τη δυνατότητα του admin να μειώνει δικαιώματα ή να μπλοκάρει λογαριασμούς όταν αυτοί παραβιάζουν την πολιτική ορθής χρήσης της πλατφόρμας.
        Επίσης, σε επίπεδο συστήματος, η χρήση του πρωτοκόλλου HTTPS για τη λειτουργία της πλατφόρμας εξασφαλί΄ζει ακεραιότητα του συστήματος από πιθανούς
        εξωτερικούς εισβολείς. </p>
