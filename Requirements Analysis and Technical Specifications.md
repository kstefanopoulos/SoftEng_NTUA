...
<p>Όπως αναφέρθηκε και παραπάνω, οι επιτρεπτές ενέργειες των Ανώνυμων Χρηστών της Πλατφόρμας είναι περιορισμένες. Πιο συγκεκριμένα οι Ανώνυμοι χρήστες μπορούν:
