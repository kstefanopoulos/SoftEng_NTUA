...
+ 3.1. Μοντελοποίηση Συμπεριφοράς Συστήματος
...
+ 4.1. Τεχνολογίες
+ 4.2. Μοντελοποίηση Δομης Συστήματος
    + 4.2.1. Διάγραμμα κλάσεων
    + 4.2.1. Διάγραμμα συστατικών
+ 4.3. Εσωτερικά Υποσυστήματα
    + 4.3.1. Serves
    + 4.3.2. Σχεδιασμός Βάσης Δεδομένων
        + 4.3.2.1. Περιγραφή Βάσης
        + 4.3.2.2. E-R Διαγράμματα
+ 4.4. Το πρόσθετο Module
+ 4.5. Εξωτερικά Υποσυστήματα
...
<p>Σκοπός της παρούσας επιχείρησης είναι η θεσμοθέτηση μιας πλατφόρμας, που θα επιτρέπει στους γονείς να έχουν πρόσβαση σε υπηρεσίες υψηλού επιπέδου, οι οποίες θα συμβάλουν στην πνευματική ολοκλήρωση και σωματική ανάπτυξη των παιδιών που συμμετέχουν σε αυτές.</p>
...
<h>**12. Προσθήκη ενός event στο Καλάθι ενός Γονέα**<h>
    <p>
    **Σκοπός** του σεναρίου είναι η αποθήκευση μιας δραστηριότητας από Γονέα.
    **Αποτέλεσμα** είναι να μπορεί ο Γονέας να ανατρέχει εύκολα στις δραστηριότητες που έχει αποθηκεύσει.
...
<p> <a href="url"><img src="UMLs/Parent_activities_updated.png" align="middle" height="700" width="900" ></a>

</p>    

<h> **Διάγραμμα δραστηριότητας οργανωτή** </h>
<p> <a href="url"><img src="UMLs/organiser_activity(1).png" align="middle" height="500" width="900" ></a>
...
<p> <a href="url"><img src="UMLs/Unregistered_user_activity(1).png" align="middle" height="500" width="700" ></a>
...
<h> **4.2. Μοντελοποίηση Δομης Συστήματος** </h> 
    <p>Η υλοποίηση του συστήματος σε επίπεδο συστατικών περιγράφεται στα παρακάτω διαγράμματα.  </p>

<h> **4.3.1. Διάγραμμα κλάσεων** </h> 
    <p>Στο παρακάτω διάγραμμα κλάσεων παρουσιάζονται οι κλάσεις που θα χρησιμοποιηθούν για την υλοποίηση της πλατφόρμας σε Java. Σε κάθε πίνακα αναράφονται ο τίτλος, τα πεδία - μεταβλητές κάθε οντότητας καθώς και οι συναρτήσεις που αυτή θα μπορεί να υλοποιεί.
...
<h> **4.3. Εσωτερικά Υποσυστήματα** </h> 
...
<h> **4.3.2. Σχεδιασμός Βάσης Δεδομένων** </h> 
<h> **4.3.2.1. Περιγραφή Βάσης Δεδομένων** </h> 
...
<p> Στην ανάπτυξη της βάσης μας έγινε χρήση των foreign keys προκειμένου να επιτύχουμε αναφορική ακεραιότητα και συνέπεια των δεδομένων μας </p> 
...
<h>**Επεξήγηση των views που χρησιμοποιήθηκαν**</h> 
    <p>Κατά την διάρκεια ανάπτυξης της βάσης μας, αναπτύχθηκαν και κάποια views ώστε να εμφανίζουμε επιλεκτικά κάποια πεδία των πινάκων στους χρήστες και όχι κάθε πληροφορία που περιλαμβάνεται σε αυτούς. </p> 
...
<h> **4.5 Eξωτερικά υποσυστήματα** </h> 
