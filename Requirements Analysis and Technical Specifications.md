...
Επιλέξαμε ως web server τον προσωπικό υπολογιστή καθενός όπου το site θα τρέχει με χρήση του Eclipse IDE. Ως database server θα χρησιμοποιηθεί το Xampp όπου θα έχει την βάση μας διαθέσιμη στο localhost. Επίσης για διαχείριση της MySQL χρησιμοποιούμε σε πρώτο στάδιο και το εργαλείο phpmyadmin. </p> 
...
<p>  Όσον αφορά το τεχνικό κομμάτι, το ψηφιακό υδατογράφημα θα προστεθεί στο pdf με χρήση της βιβλιοθήκης iText της Java, ενώ η προσθήκη ψηφιακού υαδατογραφήματος στις εικόνες 
