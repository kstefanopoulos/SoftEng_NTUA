...
επί των τιμών των παρεχόμενων υπηρεσιών, με αποδέκτες τους διαχειριστές της σελίδας. Το κέρδος των διαχειριστών της πλατφόρμας προκύπτει από την προμήθεια που λαμβάνουν, κατά την πραγματοποίηση αγορών μέσω αυτής.
...
απ' αυτό που θα λάμβανε ο πάροχος αν διέθετε τις υπηρεσίες βασιζόμενος στις δικές του δυνατότητες.</p>
